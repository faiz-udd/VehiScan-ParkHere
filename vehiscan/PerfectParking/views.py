...
class WebPages:
    ...
    ABOUT_US ="website/about.html"
    CONTACT_US="website/contact.html"
    SERVICES = "website/services.html"
    GET_QUOTE = "website/get-a-quote.html"
...
def about(request):
    return render(request, WebPages.ABOUT_US)

def services(request):
    return render(request, WebPages.SERVICES)

def contact(request):
    return render(request, WebPages.CONTACT_US)

def getQuote(request):
    return render(request, WebPages.GET_QUOTE)
